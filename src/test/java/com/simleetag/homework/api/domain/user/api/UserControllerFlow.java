...
public class UserControllerFlow extends FlowSupport {
    ...
    public UserWithHomeAndMembersResponse findUserByAccessToken(String homeworkToken) throws Exception {
        ...
        return objectMapper.readValue(responseBody, UserWithHomeAndMembersResponse.class);
    }
